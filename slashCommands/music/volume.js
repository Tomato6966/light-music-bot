...
module.exports = {
    ...
    run: async (client, interaction, args, prefix) => {
        ...
        if(!args[0] || isNaN(args[0]) || Number(args[0]) < 1 || Number(args[0]) > 150) return interaction.reply(`👎 **No __valid__ Volume between 1 and 100 % provided!** Usage: \`${prefix}volume 25\``).catch(() => null);
